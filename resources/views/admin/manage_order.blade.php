...
@section('admin_content')			
			<ul class="breadcrumb">
				...
				<li><a href="{{url('/add_category')}}">Order Details</a></li>
			</ul>
						  ...
						  <tbody>
							<tr>
								...
								<td class="center">
									...
									<a class="btn btn-danger" href="{{URL::to('/unactive_order/'.$v_order->order_id)}}"><i class="halflings-icon white thumbs-down"></i>  
									</a>
